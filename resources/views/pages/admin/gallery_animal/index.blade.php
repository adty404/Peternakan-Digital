                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" style="line-height: 30px;">Ternak - {{ $animal->name }}</h4>
                            <a href="{{ route('animal-gallery.create', ['gallery' => $animal->id]) }}">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <button href="{{ route('animal-gallery.destroy', ['gallery' => $g->id]) }}"
